                                ...
                                <tr>
                                    ...
                                    <td>                                        
                                        <div class="manage-candidate-wrap">
                                            ...
                                            <p>
                                                <span>Closes On: <b style="color: black">{{  date('D, M j, Y', strtotime($job->job->date_end))}}</b></span>
                                            </p>
                                            <p>
                                                <span>Applied On: <b style="color: black">{{  date('D, M j, Y', strtotime($job->job->created_at))}}</b></span>
                                            </p>
