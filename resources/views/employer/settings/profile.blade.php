...
<div class="row mt-5">    
    <form method="post" enctype="multipart/form-data" action="{{ url('employer/profile') }}">
        @csrf
        <div class="col-lg-12">
            <div class="user-profile-action-wrap mb-5">
                <div class="user-profile-action mb-4 d-flex align-items-center">
                    <div class="user-pro-img">                      
                        ...
                        <img src="{{ asset('uploads/profile_pictures/'.Auth::user()->avatar) }}" alt="user-image" class="img-fluid radius-round border">
                        @else
                ...
                <div class="user-form-action">
                    <div class="billing-form-item">
                        <div class="billing-title-wrap">
                            <h3 class="widget-title pb-0">Employer Profile</h3>
