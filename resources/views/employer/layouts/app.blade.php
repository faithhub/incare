...
<head>
    ...
    <!-- Template CSS Files -->
    @include('employer.layouts.includes.style')
    @include('employer.layouts.includes.alert')
</head>
<body>
<!-- start per-loader -->
...
<!-- ================================
            START HEADER AREA
================================= -->
@include('employer.layouts.includes.header')
<!-- ================================
         END HEADER AREA
================================= -->
...
<section class="dashboard-area">
    @include('employer.layouts.includes.sidemenu')
    <div class="dashboard-content-wrap">
        <div class="container-fluid">
            @yield('user')
            @include('employer.layouts.includes.footer')
...
<!-- Template JS Files -->
@include('employer.layouts.includes.script')
