            ...
            <div class="col-lg-12">
                <div class="generic-header margin-bottom-30px">
                    ...
                    <div class="short-option mr-3">
                        <select class="short-option-field select2-hidden-accessible" data-select2-id="7" tabindex="-1" aria-hidden="true">
                            <option value="" data-select2-id="9">Short by</option>
                        ...
                        </select><span class="select2 select2-container select2-container--default" dir="ltr" data-select2-id="8" style="width: 151.6px;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-disabled="false" aria-labelledby="select2-jn32-container"><span class="select2-selection__rendered" id="select2-jn32-container" role="textbox" aria-readonly="true"><span class="select2-selection__placeholder">Short by</span></span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                        ...
                        <nav>
                            <div class="nav nav-tabs generic-nav" id="nav-tab" role="tablist">
                                <a class="nav-item nav-link active" id="list-view-tab" data-toggle="tab" href="#list-view" role="tab" aria-controls="list-view" aria-selected="true">
                                    <span class="la la-list" data-toggle="tooltip" data-placement="top" title="" data-original-title="List View"></span>
                                </a>
                                <a class="nav-item nav-link" id="grid-view-tab" data-toggle="tab" href="#grid-view" role="tab" aria-controls="grid-view" aria-selected="false">
                                    <span class="la la-th-large" data-toggle="tooltip" data-placement="top" title="" data-original-title="Grid View"></span>
                                </a>
                            </div>
                        </nav>
                    </div>
                ...
                <div class="sidebar mt-0">
                    <div class="sidebar-widget">
                        ...
                        <div class="sidebar-option mb-4">
                            ...
                            <select class="category-option-field select2-hidden-accessible" data-select2-id="4" tabindex="-1" aria-hidden="true">
                            ...
                            </select><span class="select2 select2-container select2-container--default" dir="ltr" data-select2-id="5" style="width: 182px;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-disabled="false" aria-labelledby="select2-ftfq-container"><span class="select2-selection__rendered" id="select2-ftfq-container" role="textbox" aria-readonly="true"><span class="select2-selection__placeholder">Select category</span></span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                        </div><!-- end sidebar-option -->
                        <div class="sidebar-option">
                            <h3 class="widget-title">Location</h3>
                            <select class="location-option-field select2-hidden-accessible" data-select2-id="1" tabindex="-1" aria-hidden="true">
                                <option value="" data-select2-id="3">Select a Location</option>
                            ...
                            </select><span class="select2 select2-container select2-container--default" dir="ltr" data-select2-id="2" style="width: 326.8px;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-disabled="false" aria-labelledby="select2-5b7q-container"><span class="select2-selection__rendered" id="select2-5b7q-container" role="textbox" aria-readonly="true"><span class="select2-selection__placeholder">Location</span></span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                        </div><!-- end sidebar-option -->
                    ...
                    <div class="sidebar-widget">
                        <div class="billing-form-item">
                            ...
                            <div class="billing-content">
                                <div id="slider-range" class="ui-slider ui-corner-all ui-slider-horizontal ui-widget ui-widget-content"><div class="ui-slider-range ui-corner-all ui-widget-header" style="left: 10%; width: 48%;"></div><span tabindex="0" class="ui-slider-handle ui-corner-all ui-state-default" style="left: 10%;"></span><span tabindex="0" class="ui-slider-handle ui-corner-all ui-state-default" style="left: 58%;"></span></div><!-- end slider-range -->
                                            ...
                                            <div class="company-avatar mr-3">
                                                <a href="employer-details.html" class="d-block">
                                                    <svg class="card-svg" version="1.1" id="Capa_5" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 512.007 512.007" style="enable-background:new 0 0 512.007 512.007;" xml:space="preserve">
                                                        <circle style="fill:#4F0A0A;" cx="256.003" cy="256.003" r="256.003"></circle>
                                                        <path style="fill:#260505;" d="M245.901,114.471c0,0-25.629-4.553-25.966,30.35c-0.337,34.903,17.199,68.625,17.199,68.625
                                                            ...
                                                            l-0.039,0.039C252.254,115.027,245.901,114.471,245.901,114.471z"></path>
                                                        <path style="fill:#FFFFFF;" d="M400.687,310.23c0,0-0.337-15.513-24.617-23.774s-77.899,0-77.899,0
                                                            ...
                                                            C383.137,307.978,381.634,320.855,365.11,320.852z"></path>
                                    </svg>
                                                </a>
                                            </div>
                                            <div class="company-title-box">
                                            ...
                                            <div class="company-avatar mr-3">
                                                <a href="employer-details.html" class="d-block">
                                                    <svg class="card-svg" version="1.1" id="Capa_6" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 512.007 512.007" style="enable-background:new 0 0 512.007 512.007;" xml:space="preserve">
                                                            <circle style="fill:#59480C;" cx="256.003" cy="256.003" r="256.003"></circle>
                                                        <path style="fill:#382D08;" d="M367.906,206.302c-2.807,1.784-5.794,4.539-8.959,8.257l-9.814-9.814h-40.662v3.953l-48.827-48.827
                                                                ...
                                                                c-9.245-5.504-18.851-8.257-28.821-8.257C379.77,201.005,373.46,202.773,367.906,206.302z"></path>
                                                        <g>
